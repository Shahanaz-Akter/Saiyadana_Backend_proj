...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="adminto_asset/images/favicon.ico">
    <!-- App css -->
    <link href="adminto_asset/css/app.min.css" rel="stylesheet" type="text/css" id="app-style" />
    <!-- icons -->
    <link href="adminto_asset/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- fontawewsome update version link -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
    <!-- select2 css link -->
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <!-- Plugins css -->
    <link href="adminto_asset/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
    <link href="adminto_asset/libs/dropify/css/dropify.min.css" rel="stylesheet" type="text/css" />
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
    ...
    <div id="wrapper">
        ...
        <!-- start left sidebar -->
        @include('Adminview.Inventory.Ecommerce.sidebar')
        <!-- end left sidebar -->
    ...
    <!-- Vendor -->
    <script src="adminto_asset/libs/jquery/jquery.min.js"></script>
    <script src="adminto_asset/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="adminto_asset/libs/simplebar/simplebar.min.js"></script>
    <script src="adminto_asset/libs/node-waves/waves.min.js"></script>
    <script src="adminto_asset/libs/waypoints/lib/jquery.waypoints.min.js"></script>
    <script src="adminto_asset/libs/jquery.counterup/jquery.counterup.min.js"></script>
    <script src="adminto_asset/libs/feather-icons/feather.min.js"></script>

    <!-- knob plugin -->
    <script src="adminto_asset/libs/jquery-knob/jquery.knob.min.js"></script>

    <!--Morris Chart-->
    <script src="adminto_asset/libs/morris.js06/morris.min.js"></script>
    <script src="adminto_asset/libs/raphael/raphael.min.js"></script>

    <!-- Dashboar init js-->
    <script src="adminto_asset/js/pages/dashboard.init.js"></script>

    <!-- App js-->
    <script src="adminto_asset/js/app.min.js"></script>

    <!-- select2 js file -->
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>

    <!-- Plugins js -->
    <script src="adminto_asset/libs/dropzone/min/dropzone.min.js"></script>
    <script src="adminto_asset/libs/dropify/js/dropify.min.js"></script>

    <!-- Init js-->
    <script src="adminto_asset/js/pages/form-fileuploads.init.js"></script>
