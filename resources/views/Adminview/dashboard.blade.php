...
<body>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('/post_upload_products')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="container mt-5 row">
                            ...
                            <div class="col-12 col-md-5 col-lg-5  col-xl-5 form-group text-uppercase mb-5">
                            ...
                            <div class="col-12 col-md-8 col-lg-8  col-xl-8 mb-5 plus_btn btn btn-success">Add New Secondary Image <i class="fa-solid fa-plus" style="font-size: 17px;"></i></div>
    ...
    <script>
        ...
        plus.addEventListener('click', function(event) {
            ...
            div.setAttribute("class", "col-12 col-md-4 col-ld-4 col-xl-4 mb-5 mt-2");
