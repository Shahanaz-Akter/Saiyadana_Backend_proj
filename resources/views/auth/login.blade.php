    ...
    <div class="login-page bg-light">
        <div class="container bg-white pt-3 pb-3 pe-5 ps-5" style="width:80%;min-height:430px;border-radius:10px; ;">
            <div class="d-flex align-items-center justify-content-between">
                <div class="logo">
                    <img src="{{asset('asset_1/images/auth/logo.png')}}" alt="">
                </div>
                <div class="links">
                    <span>New User?</span>
                    <span><a href="{{url('/')}}" style="color:#E039F6;">Sign Up</a></span>
                </div>
            </div>

            <div class="row">
                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                    <img src="{{asset('asset_1/images/auth/login.png')}}" alt="" style="width:100%;">
                </div>
                    ...
                    <form method="POST" action="{{url('/post_login')}}">
                        ...
                        <div class="login-with mt-5">
                            ...
                            <span class="icon-holder">
                                <img src="{{asset('asset_1/images/auth/google.png')}}" alt="">
                            </span>
                            <span class="icon-holder">
                                <img src="{{asset('asset_1/images/auth/facebook.png')}}" alt="">

                            </span>
                            <span class="icon-holder">
                                <img src="{{asset('asset_1/images/auth/twitter.png')}}" alt="">
                            </span>
                        </div>
