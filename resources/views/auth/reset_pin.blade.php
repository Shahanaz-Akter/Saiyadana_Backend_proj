    ...
    <style>
        * {
        ...
        .login-page {
            ...
            display: flex;
            align-items: center;
            background-image: url("{{asset('/asset_1/images/auth/bg.png')}}");
        ...
        <div class="container bg-white pt-3 pb-3 pe-5 ps-5" style="width:70%;border-radius:10px; ;">
            ...
            <div class="row d-flex justify-content-between ">
                <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                    <img src="{{asset('asset_1/images/auth/reset.png')}}" alt="" style="width:100%;">
                </div>
                <form action="{{url('/post_resetpin/'.$user_id)}}" method="post" class="col-lg-6 col-xl-6 col-md-6 col-sm-12 d-flex justify-content-center flex-column">
                    @csrf
                    ...
                    <div class="">
                        <div class="first-example">
                            <input type="password" id="password-field" placeholder="New Pin" name="pin" style="width:90%" required>
                    ...
                    <div class="">
                        <div class="first-example">
                            <input type="password" id="password-field1" placeholder="Confirm Pin" name="confirm_pin" style="width:90%" required>
                    ...
                    <div class="">
                        <div class="first-example">
                            <input type="password" id="password-field2" placeholder="Confirm Pin" name="confirm_pin" style="width:90%" required>
                    ...
                    <!-- <div class="btn-link mt-3">
                        <a class="button mb-4" href="">Reset Pin</a>
                    </div>
                     -->
